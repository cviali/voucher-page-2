/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 9d586367ea550cff9612b30300a92426)
// Runtime types generated with workerd@1.20251210.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* voucher-page */;
